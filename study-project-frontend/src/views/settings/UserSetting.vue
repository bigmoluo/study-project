...
import {Message, Present, Refresh, Select, User} from "@element-plus/icons-vue";
...
<template>
  <div style="display: flex; max-width: 1050px; margin: auto">
    <div class="setting-left">
      <card :icon="User" title="账户信息设置" v-loading="loading.form" desc="在这里编辑您的个人信息，您可以在隐式设置中选择是否展示这些信息">
        ...
        <div>
          <el-button @click="saveDetails" :loading="loading.base" :icon="Select" type="success">保存用户信息</el-button>
        </div>
      </card>
      <card style="margin-top: 10px" :icon="Message" title="电子邮箱设置" desc="您可以在这里修改默认绑定的电子邮箱地址">
