        ...
        <div class="topic-main">
            <div class="topic-main-left">
                ...
                <div style="text-align: left; margin: 0 8px">
                    <div class="desc">微信号：{{topic.data.user.wx || '已隐藏或为填写'}}</div>
                    <div class="desc">QQ号：{{topic.data.user.qq || '已隐藏或为填写'}}</div>
                    <div class="desc">手机号：{{topic.data.user.phone || '已隐藏或为填写'}}</div>
                </div>
                <el-divider style="margin: 10px 0"/>
            ...
            <div class="topic-main-right">
                ...
                <div style="text-align: right;margin-top: 30px">
                    ...
                    <interact-button name="收藏帖子" check-name="已收藏" color="orange" :check="topic.collect"
                                     style="margin-left: 20px" @click="interact('collect','收藏')">
            ...
            <div v-if="topic.comments">
                <div class="topic-main" style="margin-top: 10px" v-for="item in topic.comments">
                    <div class="topic-main-left">
                        ...
                        <el-divider style="margin: 10px 0"/>
                        <div style="text-align: left; margin: 0 8px">
                            <div class="desc">微信号：{{item.user.wx || '已隐藏或为填写'}}</div>
                            <div class="desc">QQ号：{{item.user.qq || '已隐藏或为填写'}}</div>
                            <div class="desc">手机号：{{item.user.phone || '已隐藏或为填写'}}</div>
                        </div>
                    </div>
                    <div class="topic-main-right">
