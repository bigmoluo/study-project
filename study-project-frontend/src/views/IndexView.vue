...
import {get, logout} from "@/net/indexMethod.js";
      ...
      <el-container>
        <el-aside width="230px">
          <el-scrollbar style="height: calc(100vh - 55px)">
            <el-menu router :default-active="$route.path" style="min-height: calc(100vh - 55px)">
              <el-sub-menu index="1">
                <template #title>
...
.main-content-header {
  border-bottom: solid 1px var(--el-bg-color);
  height: 55px;
  display: flex;
  align-items: center;
